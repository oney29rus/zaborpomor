  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Чаще всего выбирают 1,5 или 1,8 м — зависит от задачи участка, соседних построек и желаемой степени закрытости. Для дачи часто достаточно 1,5 м, для частного дома — 1,8 м. Поможем подобрать высоту на замере.",
      },
      {
