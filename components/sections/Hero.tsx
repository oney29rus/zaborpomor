...
export function Hero() {
  return (
    <section className="bg-background">
      <div
        className={`${SECTION_CONTAINER} grid gap-4 py-4 sm:gap-8 sm:py-10 lg:grid-cols-2 lg:items-center lg:gap-10 lg:py-10`}
      >
        <div className="order-1 flex flex-col justify-center">
          <p className={SECTION_LABEL}>Производство и монтаж заборов</p>

          <h1 className="mt-1.5 max-w-xl text-[clamp(1.875rem,4.5vw,3.25rem)] font-bold leading-[1.15] tracking-tight text-foreground sm:mt-3 lg:max-w-2xl xl:max-w-3xl">
            Заборы под ключ
            <br />
            в&nbsp;Архангельске,
          ...
          <div className="relative z-10 mt-3 flex flex-col gap-2 sm:mt-6 sm:flex-row sm:items-center sm:gap-3">
          ...
          <ul className="mt-3 grid grid-cols-2 gap-1.5 sm:mt-6 sm:flex sm:flex-wrap sm:gap-x-0 sm:gap-y-3 lg:flex-row lg:items-center">
        ...
        <div className="order-3 lg:order-2">
          <div className="relative mx-auto w-full max-w-xl lg:max-w-none">
            <div className="relative aspect-[2/1] overflow-hidden rounded-xl border border-border sm:aspect-[5/4] sm:rounded-2xl lg:aspect-[4/3]">
              <Image
            ...
            <div className="absolute -bottom-2.5 left-2.5 rounded-lg border border-border bg-surface px-3 py-2 sm:-bottom-4 sm:left-4 sm:rounded-xl sm:px-5 sm:py-4 lg:bottom-6 lg:left-6">
              <p className="text-base font-bold tracking-tight text-foreground sm:text-xl lg:text-2xl">
                от 2 400 ₽/м
              </p>
