  ...
  return (
    <div className="lg:contents">
      <button
        ...
        className="flex w-full items-center justify-between rounded-lg border border-border bg-surface px-2.5 py-1.5 text-left text-xs font-semibold text-foreground lg:hidden"
      >
