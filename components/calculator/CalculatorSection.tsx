...
import {
  CALCULATOR_SECTION_CONTENT_MT,
  CALCULATOR_SECTION_LABEL,
  CALCULATOR_SECTION_PY,
...
export function CalculatorSection({
  ...
  const titleClassName = compactMobile ? CALCULATOR_SECTION_TITLE : SECTION_TITLE;
  const labelClassName = compactMobile ? CALCULATOR_SECTION_LABEL : SECTION_LABEL;
  const descClassName = compactMobile ? HOME_SECTION_DESC : SECTION_DESC;
  const contentMtClassName = compactMobile
    ? CALCULATOR_SECTION_CONTENT_MT
    : SECTION_CONTENT_MT;
    ...
    <section id={id} className={sectionClassName}>
      <div className={SECTION_CONTAINER}>
        ...
        >
          ...
          />
          {isUniversal ? (
            <p className="mt-2 text-center text-sm text-muted max-lg:mt-2 lg:mt-4 lg:text-left">
              <Link
